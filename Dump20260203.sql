...
CREATE TABLE `final_orders` (
  ...
  `Status` enum('pending','shipped','returned') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `sessions` VALUES ('29cmJdZKluqzcIfEiPGhJr2RSSIsiT5hLH7xs5Ka',1,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36 Edg/144.0.0.0','',1770129428);
...
-- Dump completed on 2026-02-03 15:03:44
